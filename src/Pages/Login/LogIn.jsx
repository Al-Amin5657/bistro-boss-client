...
const LogIn = () => {
    ...
    const handleValidateCaptcha = (e) => {
        const validate_capt_value = e.target.value;
        if (validateCaptcha(validate_capt_value)) {
            setDisabled(false);
        }
        else {
            setDisabled(true);
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col md:flex-row">
                    ...
                    <div className="card md:w-1/2 max-w-sm shadow-2xl bg-base-100">
                        ...
                        <p className='text-orange-600 text-center mb-4'><small>New Here? <Link to="/signUp">Create an account</Link></small></p>
